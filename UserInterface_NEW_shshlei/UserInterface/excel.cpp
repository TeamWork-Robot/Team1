...
//
CApplication CExcelFile::excel_application_;
...
void CExcelFile::CloseExcelFile(BOOL if_save)
{
    //如果已经打开，关闭文件
...
void CExcelFile::SaveasXSLFile(const CString &xls_file)
{
...
CString CExcelFile::GetSheetName(long table_index)
{
    CWorksheet sheet;
...
BOOL CExcelFile::LoadSheet(long table_index,BOOL pre_load)
{
    LPDISPATCH lpDis = NULL;
    excel_current_range_.ReleaseDispatch();
    excel_work_sheet_.ReleaseDispatch();
...
BOOL CExcelFile::LoadSheet(CString sheet,BOOL pre_load)
{
    LPDISPATCH lpDis = NULL;
    excel_current_range_.ReleaseDispatch();
    excel_work_sheet_.ReleaseDispatch();
...
//检查一个CELL是否是字符串
BOOL CExcelFile::IsCellString(long irow, long icolumn)
{
    CRange range;
...
//
CString CExcelFile::GetCellString(long irow, long icolumn)
{
...
double CExcelFile::GetCellDouble(long irow, long icolumn)
{
    double rtn_value = 0;
    COleVariant vresult;
    //字符串
...
//VT_R8
int CExcelFile::GetCellInt(long irow, long icolumn)
{
    int num;
    COleVariant vresult;
...
void CExcelFile::SetCellString(long irow, long icolumn,CString new_string)
{
...
//返回打开的EXCEL文件名称
CString CExcelFile::GetOpenFileName()
{
    return open_excel_file_;
}

//取得打开sheet的名称
CString CExcelFile::GetLoadSheetName()
{
    return excel_work_sheet_.get_Name();
}

//取得列的名称，比如27->AA
char *CExcelFile::GetColumnName(long icolumn)
{   
