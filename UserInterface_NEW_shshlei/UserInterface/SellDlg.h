...
public:
	...
	void showKabuqinuoDaBarSell();
	void showKabuqinuoXiaoBarSell();
	void showAierlanDaBarSell();
	void showAierlanXiaoBarSell();
	void showNatieDaBarSell();
	void showNatieXiaoBarSell();
