...
void CSellDlg::showPieSell()
{
	...
	ChartBar.Add(ratio,_T("摩卡大杯月内占比"),5000);
	ratio = (double)aierlanXiao / sum;
	ChartBar.Add(ratio,_T("摩卡小杯月内占比"),300);
...
void CSellDlg::showKabuqinuoDaBarSell()
{
	CSeries ChartBar;
	...
	ChartBar.AddArray(row-1, YValuesBar[0], XValuesBar[0]);
	UpdateData(FALSE);
}

void CSellDlg::showKabuqinuoXiaoBarSell()
{
	CSeries ChartBar;
	...
	ChartBar.AddArray(row-1, YValuesBar[1], XValuesBar[1]);
	UpdateData(FALSE);
}

void CSellDlg::showAierlanDaBarSell()
{
	CSeries ChartBar;
	...
	ChartBar.AddArray(row-1, YValuesBar[2], XValuesBar[2]);
	UpdateData(FALSE);
}

void CSellDlg::showAierlanXiaoBarSell()
{
	CSeries ChartBar;
	...
	ChartBar.AddArray(row-1, YValuesBar[3], XValuesBar[3]);
	UpdateData(FALSE);
}

void CSellDlg::showNatieDaBarSell()
{
	CSeries ChartBar;
	...
	ChartBar.AddArray(row-1, YValuesBar[4], XValuesBar[4]);
	UpdateData(FALSE);
}

void CSellDlg::showNatieXiaoBarSell()
{
	CSeries ChartBar;
	...
	ChartBar.AddArray(row-1, YValuesBar[5], XValuesBar[5]);
	UpdateData(FALSE);
}
...
void CSellDlg::OnSelchangeBarpieCombo()
{
	...
	switch(mIndex)
	{
		...
		break;
		case 2:
			showKabuqinuoDaBarSell();
		break;
		case 3:
			showKabuqinuoXiaoBarSell();
		break;
		case 4:
			showAierlanDaBarSell();
		break;
		case 5:
			showAierlanXiaoBarSell();
		break;
		case 6:
			showNatieDaBarSell();
		break;
		case 7:
			showNatieXiaoBarSell();
		break;
		default:
			showBarSell();
		break;
